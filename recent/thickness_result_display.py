...
import thickness_three_angle_result as result
...
ax1_1.plot(x_coordinate, result.result_angle0, color=color)
ax1_1.plot(x_coordinate, result.result_angle1, color=color)
ax1_1.plot(x_coordinate, result.result_angle2, color=color)
ax1_1.tick_params(axis='y', labelcolor=color)
...
ax1_1.plot(x_coordinate, result.result_number0, color=color)
ax1_1.plot(x_coordinate, result.result_number1, color=color)
ax1_1.plot(x_coordinate, result.result_number2, color=color)
ax1_1.tick_params(axis='y', labelcolor=color)
