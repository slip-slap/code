...
\matrix[net] (mat)
{
 ...
 |[p]| &  |[p]| & |[p]|  &  |[p]| & |[p]|  &  |[p]| &        &  |[p]| & |[p]| & |[p]| & |[p]| &       & |[p]|
  ...
  \node at (mat-3-7.base) {$...$};
  \node at (mat-3-12.base) {$...$};
  \node at (mat-3-17.base) {$...$};
  \node at (mat-3-23.base) {$...$};
 ...
 \foreach \c in {5,10,15,21,27}{
    \foreach \d in {7,12,17,23}{
 		\draw[->] (mat-2-\c.south) -- (mat-3-\d.north);
	}
 }
  % write text
  %\draw[<-] (mat-1-3.north) -- +(0,0.3cm) node[pos=0.5,auto=left] {} ;
  %\draw[<-] (mat-1-1.north) -- +(0,0.3cm) node[pos=0.5,auto=left] {} ;
  %\draw[<-] (mat-1-5.north) -- +(0,0.3cm) node[pos=0.5,auto=left] {} ;
  %\draw[<-] (mat-1-7.north) -- +(0,0.3cm) node[pos=0.5,auto=left] {} ;
  %\draw[<-] (mat-1-9.north) -- +(0,0.3cm) node[pos=0.5,auto=left] {} ;
\end{tikzpicture}
%\caption{figure}{Neural Network Model}
