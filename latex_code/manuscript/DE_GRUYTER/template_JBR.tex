...
thickness\cite{walker2003technique,lin2004stacking,kim2007development}. %Editor: Please ensure that the intended meaning has been maintained in this edit.
...
be catastrophic.%Editor: Please ensure that the intended meaning has been maintained in this edit.
...
by a near zero stiffness and strength. %Editor: Please ensure that the intended meaning has been maintained in this edit.
...
Figure \ref{fig:NxNy}(d) shows the results for the hybrid composite material.%Editor: Please ensure that the intended meaning has been maintained in this edit.
...
shown in Table \ref{tab:NxNy}.%Editor: Please ensure that the intended meaning has been maintained in this edit.
...
curve of the basic GA did not change anymore, it got trapped in the local domain.%Editor: Please ensure that the intended meaning has been maintained in this edit.
