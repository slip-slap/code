...
Each CA, GR and GL layer is assumed to cost 8, 2.5 and 1 monetary units, respectively.
...
\begin{tabular}{ccccccc}
	\toprule
	Load         &Objective Function              & Stacking sequence        & Strength ratio  & Mass &  Cost   & Layer    \\
	\midrule
	  \multirow{4}{*}{$N_{x}=1e6$ N}               &          &  $[0_{cr3}]_s$                             & 2.041           & 0.318 &  48.0  & 6  \\
					 &          &  $[0_{gr4}/0_{gr}]_s$                      & 2.227           & 0.472 &  22.5  & 9  \\
		         	 &          &  $[0_{gl6}]_s$                             & 2.103           & 0.753 &  12.0  & 12  \\
				     &          &  $[0_{gr4}/0_{gl}]_s$                      & 2.031           & 0.482 &  21.0  & 9 \\
	\bottomrule
\end{tabular}
...
\begin{tabular}{ccccccc}
	...
	Load         &Objective Function              & Stacking sequence        & Strength ratio  & Mass &  Cost   & Layer    \\
	\midrule
	 \multirow{4}{*}{$N_{y}=1e6$ N}                &          &  $[90_{cr3}]_s$                             & 2.041           & 0.318 &  48.0  & 6  \\
					 &          &  $[90_{gr4}/90_{gr}]_s$                      & 2.227           & 0.472 &  22.5  & 9  \\
           		 	 &          &  $[90_{gl6}]_s$                             & 2.103           & 0.753 &  12.0  & 12  \\
				     &          &  $[90_{gr4}/90_{gl}]_s$                      & 2.031           & 0.482 &  21.0  & 9 \\
	\bottomrule
\end{tabular}
...
\begin{tabular}{ccccccc}
	\toprule
	Load         &Function              & Stacking sequence        & Strength ratio  & Mass &  Cost   & Layer    \\
	\midrule
	\multirow{4}{*}{$N_{xy}=1e6$ N}				     &          &  $[-45_{cr6}+45_{cr7}]_s$                  & 2.013           & 1.377 &  208.0  & 26  \\
					 &          &  $[-45_{gr5}/+45_{gr23}]_s$                & 2.105           & 1.732 &  82.5   & 33  \\
		 &          &  $[-45_{gl17}+45_{gl_38}]_s$               & 2.011           & 6.908 &  110.0  & 110  \\
					 &          &  $[-45_{ca3}/+45_{ca4}/+45_{gr6}/+45_{ca}]_s$    & 2.074    & 1.424 &  150    & 27 \\
	\bottomrule
\end{tabular}
...
\begin{tabular}{ccccccc}
	...
	Load                                   &Function              & Stacking sequence                                & Strength ratio  & Mass &  Cost   & Layer    \\
	\midrule
	\multirow{3}{*}{\makecell{$N_x=1e6$ N\\ $N_y=1e6$ N}}         &                      &  $[-45_{cr6}+45_{cr6}]_s$                        & 2.026           & 1.271 &  192.0  & 24  \\
										   &                      &  $[+45_{gr10}/-45_{gr21}/+45_{gr10}]$            & 2.024           & 2.151 &  102.5  & 41  \\
	   &                      &  $[-45_{gl35}+45_{gl_73}/+45_{gl35}]$            & 2.001           & 8.980 &  143.0  & 143  \\
	\bottomrule
\end{tabular}
...
\begin{tabular}{ccccccc}
	...
	Load                                                    &Function              & Stacking sequence                          & Strength ratio  & Mass &  Cost   & Layer    \\
	\midrule
		\multirow{4}{*}{\makecell{$N_{x}=1e6 N$ \\ $N_y=1e6$ \\ $N_{xy}=1e6$}}   &                      &  $[+45_{cr12}]$                            & 2.041           & 0.636 &  96.0  & 12  \\
	         &                      &  $[+45_{gr18}]$                            & 2.227           & 0.945 &  45.0  & 45  \\
	                                                        &                      &  $[+45_{gl23}]$                            & 2.015           & 1.444 &  23.0  & 23  \\
										                    &                      &  $[+45_{gl}/+45_{gr16}/+45_{gr}]$          & 2.031           & 0.965 &  42.0  & 18 \\
	\bottomrule
\end{tabular}
