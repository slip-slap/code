...
\begin{tabular}{ccccccc}
	\toprule
	Load(N)         &  Problem             & Stacking sequence        & Strength ratio  & Mass &  Cost   & Layer    \\ 
	\midrule
	...
	\midrule
	\multirow{3}{*}{\makecell{$N_x=1e6$ \\ $N_y=1e6$ }}       &       I                &  $[\text{-}45_{cr6}/\text{+}45_{cr6}]_s$                        & 2.026           & 1.271 &  192.0  & 24  \\
	...
	$[\text{-}45_{gr9}/\text{+}45_{gr_9}/\text{-}45_{ca2}/\text{+}45_{ca2}]_s$            & 2.054         & 2.313 &
																		  154& 44  \\
	\midrule
	\multirow{4}{*}{\makecell{$N_{x}=1e6$  \\ $N_{y}=1e6$   \\ $N_{xy}=1e6$ } }  &      I   &  $[\text{+}45_{cr12}]$                            & 2.041           & 0.636 &  96.0  & 12  \\
