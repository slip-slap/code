...
% affiliations
\author{\IEEEauthorblockN{Zhang Huiyao}
\IEEEauthorblockA{Department of Fiber Science and Engineering,\\  Kyoto Institute of Technology, \\
Kyoto, 606-8585, Kyoto, Japan; Email: d8851504@kit.ac.jp \\
}
\and
\IEEEauthorblockN{Atsushi Yokoyama}
\IEEEauthorblockA{Department of Fiber Science and Engineering, \\Kyoto Institute of Technology, \\
Kyoto, 606-8585, Kyoto, Japan; Email: mailto:yokoyama@kit.ac.jp
}
}
...
\begin{abstract}
%\boldmath
	In this study, a new variant of genetic algorithm(GA) is proposed to minimize thickness of
	composite laminate subject to in-plane loading. Tsai-wu Failure criteria is used to determinte
	whether a laminate failures or not.
\end{abstract}
...
\begin{IEEEkeywords}
Genetic Algorithm; Composite laminate; Classical laminate theory, Optimal design
\end{IEEEkeywords}
...
anctive individual and a potential individual can significantly change the gene of active
...
$\text{md} = [CT_1, \cdots, CT_{n-1}, CT_n] -  [CT_0, \cdots, CT_{n-1}, CT_n]$

During the operator, the mutation consists of two parts, the length of the chromsome, and the angle
of the chromsome. Becasue the chromsome's length is positive correlated with the individual's
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{2020-11-10-pre-image/two_distinct_angle_fitness_and_sr.png}
\caption{Two distinct fiber angles}
\label{fig:two_angle_fitness_and_sr}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{2020-11-10-pre-image/two_distinct_angle_angle_change.png}
\caption{Simulation Results}
\label{fig:two_angles_angle}
\end{figure}
...
\includegraphics[width=2.5in]{2020-11-10-pre-image/two_distinct_angle_angle_change.png}
\caption{Simulation Results}
\label{fig:two_angles_number_of_angle}
\end{figure}

Figure \ref{fig:two_angle_fitness_and_sr} shows how the optimal individual's fitness and strength
ratio vary during the GA process, Figure \ref{fig:two_angles_angle} shows how the two distinct fiber
orientation changes at the same time, and Figure \ref{fig:two_angles_number_of_angle}

\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{2020-11-10-pre-image/Three_distinct_angles_fitness_and_sr.png}
\caption{Three distinct angles}
\label{fig:three_angle_fitness_sr}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{2020-11-10-pre-image/three_distinct_angles_angle_change.png}
\caption{Results}
\label{fig:three_angle_angle}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{2020-11-10-pre-image/three_distinct_angle_number_of_angle.png}
\caption{Simulation Results}
\label{fig:three_angle_number_of_angle}
\end{figure}
